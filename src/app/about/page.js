      ...
      <div className="max-w-4xl mx-auto">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 mb-4">
                We make handcrafted wool flower bouquets that never fade or wilt. Each bouquet is carefully made with
                love and attention to detail.
              </p>
              <p className="text-gray-600 mb-4">
                We have successfully delivered <strong>500+ orders across India</strong> and our customers love our
                beautiful, long-lasting flowers.
              </p>
              <p className="text-gray-600">Perfect for home decoration, gifts, or special occasions.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card className="text-center">
            ...
            <CardContent>
              <p className="text-gray-600">Successfully delivered across India</p>
            </CardContent>
          </Card>
        ...
        <div className="text-center">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Order Your Wool Flowers?</h3>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/search" className="bg-pink-600 hover:bg-pink-700 p-2 px-4 rounded-md flex items-center justify-center">
